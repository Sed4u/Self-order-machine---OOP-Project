...
void Interfata::populeazaMeniu(Meniu *meniu) {
    const vector<Element*> mancare = {
        new Mancare("Big Mac", 508, 18.00, 219),
        new Mancare("McChicken", 403, 17.00, 173),
        new Mancare("Cheeseburger", 301, 7.00, 115),
        new Mancare("Double Cheeseburger", 445, 12.00, 155),
        new Mancare("Chicken McNuggets (6 bucati)", 259, 14.00, 87),
        new Mancare("Filet-o-Fish", 327, 17.50, 142),
        new Mancare("McWrap Crispy", 479, 19.00, 215),
        new Mancare("Cartofi prajiti", 320, 9.50, 117),
        new Mancare("McMuffin cu Ou si Bacon", 295, 12.00, 113),
        new Mancare("McToast", 265, 6.50, 102),
        new Bautura("Coca-Cola", 112, 7.00, 250),
        new Bautura("Fanta", 105, 7.00, 250),
        new Bautura("Sprite", 100, 7.00, 250),
        new Bautura("Milkshake", 330, 12.00, 300),
        new Bautura("Cafea", 0, 6.00, 250),
        new Bautura("Apa plata", 0, 5.00, 500),
        new Bautura("Suc de portocale", 150, 10.00, 400)
    };
                            ...
                            case 1: {
                               ...
                               cin >> optiune_aduagare;
                                if (optiune_aduagare == 1)
                                    staff.adauga_element<Mancare>();
                                else if (optiune_aduagare == 2)
                                    staff.adauga_element<Bautura>();
